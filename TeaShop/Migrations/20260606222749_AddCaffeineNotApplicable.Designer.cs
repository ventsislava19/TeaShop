...
namespace TeaShop.Migrations
{
    ...
    [Migration("20260606222749_AddCaffeineNotApplicable")]
    partial class AddCaffeineNotApplicable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeaShop.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TeaShop.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TeaShop.Models.Order", b =>
                {
                    b.HasOne("TeaShop.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
